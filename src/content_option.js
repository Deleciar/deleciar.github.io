...
const meta = {
    ...
    description: "Civil & Project Engineer | Isle of Man | Drainage, Water Infrastructure, BIM & Sustainable Engineering",
};
...
const introdata = {
    ...
    animated: {
        ...
        second: "Sustainable Drainage Specialist",
    ...
    your_img_url: "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=900&q=80",
};
...
const worktimeline = [
    ...
    {
        jobtitle: "Civil Engineer / Technologist",
        where: "Golder Associates Africa, Johannesburg, SA",
        date: "Feb 2018 to Feb 2019",
    },
    {
        jobtitle: "Bridge & Civil Engineering Technician",
        where: "SMEC South Africa, Durban and Pretoria",
        date: "Aug 2015 to Feb 2018",
    },
    {
        jobtitle: "Intern / Civil Engineering Technician",
        where: "BVI Consulting Engineers, Durban, SA",
        date: "Jan 2013 to Aug 2015",
    },
];

const skills = [
    { name: "AutoCAD Civil 3D", value: 92 },
...
const services = [
    {
        ...
        description: "Design and evaluation of drainage and surface water management systems integrating sustainable and nature-based solutions including SuDS, swales, filter strips, v-drains, and infiltration ponds to manage surface water runoff, in accordance with CIRIA C753 and national standards.",
    },
    {
...
const dataportfolio = [
    ...
    },
    {
        ...
        title: "Eastgate Solar PV Project",
        employer: "Nicholas O'Dwyer",
        date: "2023",
        category: "Renewable Energy / Drainage",
        description: "Solar PV Site Drainage Design, Northern Ireland",
        details: "Designed the full civil drainage scheme for the Eastgate Solar PV Site, building on knowledge and methodology developed for the Sherborne Solar Farm. Developed drainage schematics, calculated material quantities, and produced the civil Basis of Design report. Submitted Pre-Development Enquiries (PDEs) and Wastewater Impact Assessment (WwIA) applications to NI Water. Applied passive drainage principles throughout, incorporating infiltration features to manage site runoff sustainably.",
    },
    {
        img: "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=600&q=80",
        title: "Ardee & Westgate 2040 Regeneration",
        employer: "Nicholas O'Dwyer",
        date: "2021 to 2024",
        category: "Urban Infrastructure / Planning",
        description: "Public Realm Regeneration, Louth County Council, Ireland",
        details: "Part of the design team contributing to the planning applications for both the Westgate and Ardee 2040 regeneration schemes for Louth County Council. Developed the material assets section for the Environmental Impact Assessment (EIA) Report, designed a comprehensive surface water drainage plan, and assisted the senior engineer with flood risk assessment. Acted as liaison between the project team, clients, and regulatory bodies throughout the planning application process.",
    },
    {
        img: "https://images.unsplash.com/photo-1505816014357-96b5ff457e9a?w=600&q=80",
        title: "Ballymoney Public Realm Project",
        employer: "Nicholas O'Dwyer",
        date: "2022 to 2023",
        category: "Urban Infrastructure",
        description: "Main Street Upgrade, Ballymoney, Northern Ireland",
        details: "Assisted with the planning application submission for the Ballymoney Public Realm rehabilitation project, a Main Street area upgrade. Supervised the development of detailed design drawings, assumed project management responsibilities when a senior engineer departed, and acted as the primary liaison between the project team and clients. Maintained regular client communication to ensure project milestones and deliverables were met on schedule.",
    },
    {
        img: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&q=80",
        title: "Farrans Regional Connections",
        employer: "Nicholas O'Dwyer",
        date: "2022 to 2023",
        category: "Water & Foul Networks",
        description: "Foul and Water Network Upgrades, Ireland and Northern Ireland",
    ...
    },
    {
        ...
        date: "2019 to 2020",
        category: "Water Treatment / BIM",
        description: "WTW Upgrade, Roundwood, Ireland",
        details: "Produced long sections for all interconnecting pipework around the Vartry Water Treatment Plant using AutoCAD Civil 3D. Modelled interconnecting pipes in Revit to meet BIM Level 2 requirements. Performed basic thrust block designs and conducted calculation checks. Delivered AutoCAD Civil 3D and Revit in-house training presentation to the TOBIN team, earning mentoring CPD recognition. Part of a broader Irish Water upgrade programme.",
    },
    {
        img: "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=600&q=80",
        title: "Water Networks Upgrade, Midlands Ireland",
        employer: "TOBIN Consulting Engineers",
        date: "2019",
    ...
    },
    {
        ...
        title: "Columbus Stainless Stormwater Management",
        employer: "Golder Associates Africa",
        date: "2018",
        category: "Stormwater / Mine Water",
        description: "Stormwater Management System, Middelburg, South Africa",
        details: "Conducted a concept study and created a Basis of Design and concept drawings for the stormwater management system at Columbus Stainless in Middelburg, Mpumalanga. Work included flood routing and catchment runoff calculations, stormwater channel sizing, sizing of pollution control dams, and design of sediment traps, taking into account the proximity of a lime quarry on the neighbouring site. Generated a full set of detail drawings for the Pollution Control Dam, stormwater channel details, long sections, and layouts. Prepared technical memorandums, reports, and capital and operational cost estimates.",
    },
    {
        img: "https://images.unsplash.com/photo-1565008447742-97f6f38c985c?w=600&q=80",
        title: "Vale Moatize & Tenke Fungurume Mine Pipelines",
        employer: "Golder Associates Africa",
        date: "2018",
        category: "Mine Water / Pipeline Design",
        description: "Return Water and Slurry Pipeline Design, Mozambique and DRC",
        details: "Developed tender drawings for upgrades to the return water and slurry pipeline and pump stations at Vale Moatize Coal Mine (Mozambique) and Tenke Fungurume Mine (Democratic Republic of Congo). Deliverables included layouts, long sections, and detailed drawings for both the return water pump station and pipeline, and the slurry pump station and pipeline. Engaged in 3D pipe network drafting, pipe schedule creation, and site inspection coordination across transnational African mining projects.",
    },
    {
        img: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=600&q=80",
        title: "Lesotho Lowlands Bulk Water Supply",
        employer: "SMEC South Africa",
        date: "2016 to 2018",
        category: "Water Supply / BIM",
        description: "Bulk Water Supply Network, Lesotho",
    ...
    },
    {
        ...
        title: "Low-Cost Housing Schemes, KwaZulu-Natal",
        employer: "BVI Consulting Engineers",
        date: "2013 to 2015",
        category: "Residential / Public Works",
